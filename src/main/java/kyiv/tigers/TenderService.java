 ...
 * @since 08/02/20 16:54
 */
@Service
public class TenderService implements Importer{

    private static final Logger logger = Logger.getLogger(TenderService.class.getName());
    private static final String SELECT_DATA = stringFromFile("sql/publicbid/selectTenders.sql");
    private static final String COUNT_QUERY = stringFromFile("sql/publicbid/selectCountTenders.sql");
    private static final String INSERT_DATA = stringFromFile("sql/opentender/insertTenders.sql");
    private static final String UPDATE_DATA = stringFromFile("sql/publicbid/updateTender.sql");
    ...
    public TenderService(@Qualifier("publicbidJdbcTemplate") NamedParameterJdbcTemplate publicbidJdbcTemplate,
    ...
    private SqlParameterSource insertValue(Map<String, Object> value){
        ...
        opentenderJdbcTemplate.update(
                ...
                new MapSqlParameterSource()
                        ...
                        .addValue("tender_id", value.get("tender_id"))
    ...
    public boolean start(){
        ...
        try{
            ...
            while((values = selectValues(PageRequest.of(page, pageSize))).size() != 0){
                ...
                page++;
                logger.info("Tenders: " + allUpdated + "/" + count + "(" + (100 * allUpdated/count) + "%)");
            }
